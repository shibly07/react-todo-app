...
const Form = ({
  ...
  return (
    <form
      onSubmit={addTodo}
      className=" h-[3.375rem] w-2/3 md:w-[46rem] flex gap-2 md:gap-4 items-center absolute left-1/2 transform -translate-x-1/2 top-[6.25rem] md:top-[10.9375rem]"
    >
      {/* Input text box */}
      <input
        type="text"
        placeholder="Add a new task"
        className="px-4 h-full w-full md:h-[3.375rem] md:w-[39.0625rem] text-white bg-[#262626] rounded-md "
